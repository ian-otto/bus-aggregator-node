            ...
            if(err) {
                ...
                try {
                    ...
                    for(let part of body_json.vehicles) {
                        ...
                        tmp.setLocation(part.position[0], part.position[1], part.heading);
                        tmp.setAndReturn("vehicleId", parseInt(part.id))
                ...
                try {
                    ...
                    for(let part of body_json.arrivals) {
                        ...
                        etas.push(tmp.setAndReturn("vehicleId", part.vehicle_id)
                            .setAndReturn("etaSeconds",  part.timestamp - new Date().getTime() / 1000)
                            .setAndReturn("routeId", part.route_id)
                            .setAndReturn("linkName", "Transloc").setAndReturn('tripNumber', '0').build());
                    }
                    cb(null, etas);
                } catch(e) {
                    cb(e, null);
